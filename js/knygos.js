...
const religineButton = document.getElementById("religineButton");
const teisineButton = document.getElementById("teisineButton");
const grozineContent = document.getElementById("grozineContent");
const reiligineContent = document.getElementById("religineContent");
const teisineContent = document.getElementById("teisineContent");
let numgrozine = document.getElementById("grozineButton").attributes.length;
let numreligine = document.getElementById("religineButton").attributes.length;
let numteisine = document.getElementById("teisineButton").attributes.length;
grozineButton.addEventListener("click", () =>
  displayBooks("grozine", innerHTML = numgrozine, grozineContent)
);
religineButton.addEventListener("click", () =>
  displayBooks("religine", (innerHTML = numreligine), reiligineContent)
);
teisineButton.addEventListener("click", () =>
  displayBooks("teisine", innerHTML = numteisine, teisineContent)
);
